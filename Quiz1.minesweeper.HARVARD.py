...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        # Create a new sentence based on the new information
        ...
        while True:
            ...
            updated_mines = []
            for sentence in self.knowledge:
                safes, mines = sentence.known_safes_mines()
                if safes:
                    updated_safes += safes
                    for s in safes:
                        self.mark_safe(s)
                if mines:
                    ...
                    for m in mines:
                        self.mark_mine(m)
            if not updated_safes and not updated_mines:
                break
    ...
    def make_safe_move(self):
        ...
        """
        return self.cells not in self.moves_made
        raise NotImplementedError
